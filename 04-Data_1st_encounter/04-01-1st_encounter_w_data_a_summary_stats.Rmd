...
# Data Analysis Case Study: Summary Statistics
...
First, we nee to install the necessary packages.  The data are in a package stored on GitHub called wildlifeR.  The devtools package is needed for downloading from github.  We'll use the ggplot2 package for plotting, and the cowplot package for some nice plotting defaults.  We'll also use the ggpubr package for plotting and dplyr for reshaping data.
...
We can get the grand mean of just the mass column
```{r}
