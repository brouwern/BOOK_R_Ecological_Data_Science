...
```{r echo=FALSE, fig.cap = "The R logo"}
...
```{r rstudio.logo, echo=FALSE, fig.cap = "The RStudio logo"}
...
```{r rstudio.open, echo=FALSE , fig.cap = "RStudio when first opened."}
...
```{r rstudio.console, echo=FALSE, fig.cap = "RStudio's console and script editor."}
