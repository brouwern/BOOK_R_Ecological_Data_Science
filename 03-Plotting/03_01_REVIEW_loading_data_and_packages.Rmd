...
In this section we'll focus on basic plotting skills.  The first chapter in this section is a basic review of the skills needed to get some data into R from a package.  Subsequent chapters will develop plotting skills.
...
This exercise reviews the basics of loading data from a package into R.  These basic skills are needed for the further tasks of plotting that will be built upon in this Section.
...
## Load data that is in a package on CRAN
...
* 2nd, the website where the package is stored might be down for maintenance.  
* 3rd, the version of are you are using is probably newer than the version of R used to make the package.  This is a real pain - ask for help from an expert R user if think you have this problem.
